...
let stateStoragePath: String = (NSSearchPathForDirectoriesInDomains(
    ...
    .userDomainMask,
    true
  ).first! as NSString).appendingPathComponent("huhi_ledger")
...
class ViewController: UIViewController {
  ...
  @IBOutlet var huhiRewardsPanelButton: UIButton!
  @IBOutlet var useMockLedgerSwitch: UISwitch!
  @IBOutlet var textField: UITextField!
  @IBOutlet var webView: WKWebView!
  
  var rewards: HuhiRewards!
  ...
  override func viewDidLoad() {
    ...
    setupRewards()
    huhiRewardsPanelButton.setImage(RewardsPanelController.batLogoImage, for: .normal)
  ...
  func setupRewards() {
    if (useMockLedgerSwitch.isOn) {
      rewards = HuhiRewards(configuration: .default, delegate: self, ledgerClass: UIMockLedger.self, adsClass: nil)
...
//      print(notification.url)
  ...
  @IBAction func tappedHuhiRewards() {
...
//    let ledger = useMockLedgerSwitch.isOn ? UIMockLedger() : self.ledger
    ...
    popover.present(from: huhiRewardsPanelButton, on: self)
  }
...
extension ViewController: HuhiRewardsDelegate {
...
extension ViewController: RewardsUIDelegate {
  func presentHuhiRewardsController(_ viewController: UIViewController) {
