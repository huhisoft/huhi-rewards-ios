...
public class AdsNotificationHandler: HuhiAdsNotificationHandler {
  ...
  ///
  /// - note: This method automatically sets `notificationsHandler` on BATHuhiAds
  /// to itself
  public init(ads: HuhiAds, presentingController: UIViewController) {
    self.ads = ads
