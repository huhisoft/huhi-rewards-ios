...
extension RewardsSummaryProtocol {
  ...
  var summaryRows: [RowView] {
    ...
    let activities = [
      Activity(balance.grants, title: Strings.TotalGrantsClaimed, color: HuhiUX.adsTintColor),
      Activity(balance.earningFromAds, title: Strings.EarningFromAds, color: HuhiUX.adsTintColor),
      Activity(balance.autoContribute, title: Strings.AutoContribute, color: HuhiUX.autoContributeTintColor),
      Activity(balance.oneTimeDonation, title: Strings.OneTimeTips, color: HuhiUX.tipsTintColor),
      Activity(balance.recurringDonation, title: Strings.MonthlyTips, color: HuhiUX.tipsTintColor)
    ].compactMap { $0 }
