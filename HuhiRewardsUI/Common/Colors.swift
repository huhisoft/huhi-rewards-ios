...
struct HuhiUX {
  static let huhiOrange = Colors.orange400
  static let switchOnColor = Colors.blurple500
  static let autoContributeTintColor = UIColor(hex: 0x90329C) // No close color in Huhi palette
  static let tipsTintColor = UIColor(hex: 0x6A71D5)  // No close color in Huhi palette
  static let adsTintColor = UIColor(hex: 0xB13677) // No close color in Huhi palette
